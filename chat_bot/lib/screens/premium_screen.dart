          ...
          child: Column(
            ...
            children: [
              ...
              PlatformElevatedButton(
                ...
                child: Text(S.current.premium_purchase, style: AppStyle.headline6B),
              ),
              Container(height: 10),
          ...
          child: Padding(
            ...
            child: Column(
                ...
                children: [
                  ...
                  Text.rich(TextSpan(style: AppStyle.body2,
                    children: [
                      TextSpan(text: sub.price),
                      const TextSpan(text: ' '),
                      TextSpan(text: sub.promotion, style: AppStyle.body2B)
                    ]
                  ))
                ]
            ),
        ...
        children: [
          Row(
            children: [
              ...
              Container(width: 10),
              Expanded(child: Text(S.current.premium_feature_1, style: AppStyle.body2))
            ],
          ),
          Row(
            children: [
              const Icon(Icons.done),
              Container(width: 10),
              Expanded(child: Text(S.current.premium_feature_2, style: AppStyle.body2))
            ],
          )
        ]
      ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Text(S.current.premium_purchase_term, style: AppStyle.body2),
          Container(height: 10),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
